...
let contractAddress = '0x3dfc703169990879422BbE08d23dAb63fa8BbA96';
...
contract.methods.getTokenPrice().call()
	...
	{
	    tokenPrice = _result;
	    contract.methods.purchaseTokens(tokensToPurchase).send({from:user1,value:tokensToPurchase*tokenPrice}).on('transactionHash', function(hash){
		console.log("txhash: " + hash);
	    }).then(function(_result){result = _result;
				      console.log(result)});
	});
